...
static constexpr tap::motor::MotorId YAW_MOTOR_ID_1 =
    tap::motor::MotorId::MOTOR1;  // May have to change these
static constexpr tap::motor::MotorId YAW_MOTOR_ID_2 = tap::motor::MotorId::MOTOR2;
...
static constexpr tap::algorithms::SmoothPidConfig YAW_POS_PID_CONFIG = {
    ...
    // .ki = 0.0f,
    // .kd = 5.0f,
    .kp = 30.0f,  // Test bot = kp 25.0f * 2 / 3, kd 2.4 * 2 / 3 // Main bot = kp 30, kd 3
    .ki = 0.0f,
    .kd = 3.0f,
    .maxICumulative = 0.0f,
...
static constexpr tap::algorithms::SmoothPidConfig YAW_VEL_PID_CONFIG = {
    ...
    // .ki = 20.0f,
    // .kd = 500.0f,
    .kp = 10000.0f,  // Test bot = kp 9000.0f * 2 / 3, kd 900.0f * 2 / 3 // Main Bot kp = 10000 kd =
                     // 1000
    .ki = 0.0f,
    .kd = 1000.0f,
...
static constexpr tap::algorithms::SmoothPidConfig PITCH_PID_CONFIG = {
    ...
    .kp = 0.0f,  // TODO for imu cal command
    .ki = 0.0f,
    .kd = 0.0f,
    .maxICumulative = 0.0f,
    .maxOutput = DjiMotorConstants::MAX_OUTPUT_GM6020,  // 0.0f
