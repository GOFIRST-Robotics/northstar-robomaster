...
//      * @param[in] yawControllerTop Pointer to a yaw controller that will be used to control the
//      yaw
//      * axis of the turret.
//      * @param[in] pitchControllerTop Pointer to a pitch controller that will be used to control
//      the
//      * pitch axis of the turret.
//      ** @param[in] yawControllerBottom Pointer to a yaw controller that will be used to control
//      the yaw
//      * axis of the turret.
//      * @param[in] pitchControllerBottom Pointer to a pitch controller that will be used to
//      control the
//      * pitch axis of the turret.
//      * @param[in] userYawInputScalar Value to scale the user input from
