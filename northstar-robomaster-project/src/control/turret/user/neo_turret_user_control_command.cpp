...
#include "neo_turret_user_control_command.hpp"
...
{
NeoTurretUserControlCommand::NeoTurretUserControlCommand(
    tap::Drivers *drivers,
...
bool NeoTurretUserControlCommand::isReady()
{
    return !isFinished();  //&& this->yawController->isOnline();  // TODO hero needs comented out
}

void NeoTurretUserControlCommand::initialize()
{
...
void NeoTurretUserControlCommand::execute()
{
...
bool NeoTurretUserControlCommand::isFinished() const
{
    return !pitchController->isOnline() && !yawController->isOnline();
}

void NeoTurretUserControlCommand::end(bool)
{
