...
{
static constexpr float FRICTION_WHEEL_RAMP_SPEED = 2.0f;
...
static constexpr float FLYWHEEL_DUTY_PID_MAX_OUTPUT = 0.15f; //does not affect feed forward, only the pid output
