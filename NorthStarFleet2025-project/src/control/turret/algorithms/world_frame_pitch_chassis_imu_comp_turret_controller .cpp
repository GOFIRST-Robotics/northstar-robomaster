...
#include "world_frame_pitch_chassis_imu_comp_turret_controller.hpp"
...
WorldFramePitchChassisImuCompTurretController::WorldFramePitchChassisImuCompTurretController(
    tap::Drivers &drivers,
...
void WorldFramePitchChassisImuCompTurretController::initialize()
{
...
void WorldFramePitchChassisImuCompTurretController::runController(
    const uint32_t dt,
    const WrappedFloat desiredSetpoint)
{
    ...
    float pidOutput = pid.runController(
        ...
        turretMotor.getChassisFrameVelocity() + getPitchVelo(),
        dt);
...
void WorldFramePitchChassisImuCompTurretController::setSetpoint(WrappedFloat desiredSetpoint)
{
    updateWorldFrameSetpoint(
        desiredSetpoint,
        chassisFrameInitImuPitchAngle,
...
WrappedFloat WorldFramePitchChassisImuCompTurretController::getMeasurement() const
{
    const WrappedFloat chassisFrameImuPitchAngle = getBmi088Pitch();
...
bool WorldFramePitchChassisImuCompTurretController::isOnline() const
{
...
WrappedFloat WorldFramePitchChassisImuCompTurretController::convertControllerAngleToChassisFrame(
...
WrappedFloat WorldFramePitchChassisImuCompTurretController::convertChassisAngleToControllerFrame(
