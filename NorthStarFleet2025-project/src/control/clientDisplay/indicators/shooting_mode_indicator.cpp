...
#include "shooting_mode_indicator.hpp"
...
modm::ResumableResult<void> ShootingModeIndicator::update()
{
    // Access the correct field depending on the robot type

    firemode = shootCommand.getLaunchMode();

    numberIndicator.setIndicatorState(firemode);
...
modm::ResumableResult<void> ShootingModeIndicator::sendInitialGraphics()
{
    RF_BEGIN(0);
...
void ShootingModeIndicator::initialize()
{
